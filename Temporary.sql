...
/*Para relacionar y cargar mas rapido*/
ALTER TABLE Proyectos
ADD relacion_id int(11) NULL
AFTER total_disbursements;

ALTER TABLE Nivel
ADD relacion_geo int(11) NULL
AFTER even_split_disbursements;

ALTER TABLE Nivel
ADD relacion_pro int(11) NULL
AFTER relacion_geo;